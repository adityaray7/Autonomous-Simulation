...
x, y = input('Enter starting Coordinates (x,y)').split()
x = int(x)
y = int(y)
...
class Car:
    ...
    def __init__(self):
        ...
        self.sprite = pygame.image.load(
            car_name).convert()  # Convert Speeds Up A Lot
...
def run_simulation(genomes, config):
    ...
    while True:
        ...
        # for car in cars:
        #     if still_alive <= 5 and car.speed == 0:
        #         break
        ...
        counter += 1
        if counter == 30 * 10:  # Stop After About 20 Seconds
            break
